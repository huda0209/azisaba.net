...
2. <u>Choose a Version</u>の項目で<u>OpenJDK 8 (LTS)</u>を選択します。
3. 下の<u>Latest release</u>をクリックしてダウンロード開始！
...
1. Paperと同じフォルダ内で右クリックして<u>新規作成</u>から<u>テキスト ドキュメント</u>を選択！
...
3. 作成した `start.bat` を右クリックして<u>編集</u>を選択します。
...
5. 入力し終わったら、 `Ctrlキー` と `Sキー` を同時押しして保存してから閉じます！
